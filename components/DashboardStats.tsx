...
export default async function DashboardStats() {
  ...
  let blogs = 0
  let testimonials = 0
  let learningJourney = 0
  let education = 0

  try {
    ;[projects, skills, messages, blogs, testimonials, learningJourney, education] = await Promise.all([
    ...
    console.error('Failed fetching dashboard counts', err)
  }
